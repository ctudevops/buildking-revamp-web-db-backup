...
LOCK TABLES `components_shared_seos_cmps` WRITE;
/*!40000 ALTER TABLE `components_shared_seos_cmps` DISABLE KEYS */;
/*!40000 ALTER TABLE `components_shared_seos_cmps` ENABLE KEYS */;
UNLOCK TABLES;
