...
LOCK TABLES `components_shared_open_graphs` WRITE;
/*!40000 ALTER TABLE `components_shared_open_graphs` DISABLE KEYS */;
/*!40000 ALTER TABLE `components_shared_open_graphs` ENABLE KEYS */;
UNLOCK TABLES;
